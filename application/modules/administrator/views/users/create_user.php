<div class="row">
	<div class="col-md-12">
<?php echo form_open(site_url('administrator/users/insert'), array('class' => 'form-horizontal', 'id' => 'form_add_user')); ?>
			...
			<div class="form-group">
				<label class="col-sm-2"> <?php echo lang('field_password') ?> <small><i>(<?php echo lang('required'); ?>)</i></small></label>
				<div class="col-sm-6">
	 ...
	 *
	 **/
	echo form_dropdown('role', array_column($role_access, 'role_name', 'role_id'),NULL, array('class' => 'form-control col-sm-10'));
	?>
				</div>
