...
<?php echo form_open_multipart(site_url("administrator/post/update/{$get->ID}"), array('class' => 'form-horizontal', 'id' => 'form_add_user')); ?>
		<div class="col-md-9">
		...
		<div class="col-md-3">
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					...
					?>
							<option value="<?php echo $cat->category_id; ?>" <?php echo $this->post->category_id($get->ID, $cat->category_id); ?>><?php echo $cat->name; ?></option>
					<?php  
					endforeach;
					?>
						</select>
						...
						<div class="padding">
							<input type="text" name="tags" id="form-field-tags" value="<?php echo $get->post_tag; ?>" placeholder="Enter <?php echo lang('menu_post_tags') ?> ..." />
						</div>
					</div>
				</div>
			</div>
